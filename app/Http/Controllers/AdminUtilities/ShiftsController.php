    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            if (!in_array(SYSTEM_COMPONENT_ADMIN_SHIFT, $this->getListByAccess(ACCESS_TYPE_SYSTEM_COMPONENT, ACCESS_UPDATE,$user))) {
                 throw new Exception('Cant locat your shift ',400);
               }
        ...
        $weekdays=$edit_list->weekdays();
            ...
            foreach ($weekdays as $key => $value) {
               ...
               if (in_array($value['day'], $array)) {
                    ...
                    $shift_weekdays[$key]['name']=$days[$key];
            ...
            $shift_end_hour = ( (int) $shift_start_hour + (int) $shift_length_hour);
            $shift_end_min = ( (int) $shift_start_min + (int) $shift_length_min);
            if ($shift_end_min >= 60) {
