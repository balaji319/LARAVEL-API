...
class List extends React.Component {
  ...
  handleKeyPress = event => {
    if (event.key == "Enter") {
      ...
      this.props.fetchAllScript(0, rowsPerPage, this.state.search_value);
    }
  };
  ...
  handleStartCloning = () => {
    ...
    if (!isError) this.setState({ showCloneConfirm: true, showAlert: false });
  };
  ...
  handleShowClonePopup = () => {
    ...
    this.setState({ showClonePopup: true, showAlert: false });
  };

  handleCloneConfirm = () => {
    this.setState({ showCloneConfirm: false, showAlert: false });
    let _this = this;
    axios
  ...
  componentWillReceiveProps(nextPropsFromRedux) {
    this.setState({
      ...
      total: nextPropsFromRedux.admin_utilites.total,
    ...
    if (nextPropsFromRedux.admin_utilites.showMessage) {
      this.props.fetchAllScript(
        this.state.page,
        this.state.rowsPerPage,
        this.state.search_value
  ...
  fetchList(page = 0, page_size = 10) {
    ...
    this.props.fetchAllScript(current_page, page_size, search_value);
  }
  ...
  handleChangePage = (event, page) => {
    this.setState({ page, showAlert: false });
