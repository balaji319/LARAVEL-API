...
class EditScript extends React.Component {
            ...
            if (optioncount.indexOf(item.option_value) > -1) {
              ...
              return {
                ...
                ["option_route_value_context"]:
                  callmenu_list[temp_index].option_route_value_context != null
  ...
  handleSubmit = () => {
    ...
    menu_name == ""
      ? (this.setState({ menu_nameError: true }), (error = true))
      : this.setState({ menu_nameError: false });
    menu_id == ""
      ? (this.setState({ menu_idError: true }), (error = true))
      : this.setState({ menu_idError: false });
