...
class Edit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      totaltime: "",
      reportoption: "N",
      report_rank_data: report_rank_data,
      report_rank: "1",
      agent_group: [],
    ...
    if (nextPropsFromRedux.Agent.record_data) {
      this.setState({
        ...
        usergroup: nextPropsFromRedux.Agent.record_data.data.user_group
          ...
          : "",
        totaltime: nextPropsFromRedux.Agent.record_data.data.shift_length
          ? nextPropsFromRedux.Agent.record_data.data.shift_length
          : "",
        reportoption: nextPropsFromRedux.Agent.record_data.data.report_option
          ? nextPropsFromRedux.Agent.record_data.data.report_option
          : "",
        shiftstime: nextPropsFromRedux.Agent.record_data.data.shift_start_time
          ? nextPropsFromRedux.Agent.record_data.data.shift_start_time
          : "",
        shiftetime: nextPropsFromRedux.Agent.record_data.data.shift_end_time
          ? nextPropsFromRedux.Agent.record_data.data.shift_end_time
          : "",
        week_checked: nextPropsFromRedux.Agent.record_data.data.shift_weekdays
          ? nextPropsFromRedux.Agent.record_data.data.shift_weekdays
          : shift_weekdays,
        report_rank: nextPropsFromRedux.Agent.record_data.data.report_rank
          ? nextPropsFromRedux.Agent.record_data.data.report_rank
          : "1"
      });
      console.log("++++++++++++11");
      ...
      this.setState({
        //agent_group: nextPropsFromRedux.Global.agentgroup
  ...
  handleCheckedChange(index, dataType, value, data) {
    ...
    this.setState({ week_checked: newState, is_change: true });
  }
  ...
  handleSubmit = () => {
    ...
    let report_rank = this.state.report_rank;
    ...
    let selected_days = this.state.week_checked.filter(
                      ...
                      return (
                        <div key={week_checked[index].day}>
                          ...
                          <Checkbox
                            ...
                            checked={week_checked[index].checked}
                          />{" "}
                ...
                <div className="col-md-12">
                  <div className="form-group">
                    <TextField
                      ...
                      tabIndex="-1"
                      value={report_rank}
                      onChange={this.handleChange("report_rank")}
                      fullWidth
                    >
                      {report_rank_data.map((option, i) => (
