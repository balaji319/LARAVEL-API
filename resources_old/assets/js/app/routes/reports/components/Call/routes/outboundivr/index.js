          ...
          if (data.timestat[i][1] > 0) {
            for (j = 0; j < counts1.length; j++) {
              if (counts1[j].key == data.timestat[i][1].trim()) {
                ...
                } else key_co = data.timestat[i][1].trim();
              }
            }
            ...
            if (data.timestat[i][1]) {
              my_data.push({
                first: data.timestat[i][0],
                data: data.timestat[i][1],
                last_key: last_key,
                remain1: remain1,
                count: count
              });
      ...
      <div>
        ...
        {isShow ? (
          <Card className="shadow border-0 bg-default text-black">
            <CardBody>
              <span>
                <label className="card-title">IVR Stats Repor:</label>
                &nbsp;&nbsp;
                  ...
                  <Table>
                    <TableHead>
                      ...
                      <TableRow>
                        ...
                        <TableCell
                          onClick={() => this.clickCol(3, "QUEUE DROP CALLS")}
                        >
                          {displayAs == "HTML" ? (
                            <button className="bg-success text-white">
                              IVR CALLS
                        ...
                        <TableCell
                          onClick={() => this.clickCol(5, "IVR AVG TIME")}
                        >
                          {displayAs == "HTML" ? (
                            <button className="bg-success text-white">
                              IVR CALLS
                        ...
                        <TableCell
                          onClick={() => this.clickCol(6, "TOTAL AVG TIME")}
                        >
                          {displayAs == "HTML" ? (
                            <button className="bg-success text-white">
                              IVR CALLS
                    ...
                    <TableBody>
                        ...
                        <TableRow key={key}>
                          ...
                          >
                            {activeCol == 1 ? (
                              <Progress
                                strokeWidth={30}
                                percent={parseInt(data.total_ivr[key].ivrcalls)}
                              />
                            ) : (
                              data.total_ivr[key].ivrcalls
                            )}
                          </TableCell>
                          <TableCell
                            className={
                          ...
                          >
                            {activeCol == 4 ? (
                              ...
                              data.total_ivr[key].dropcallpercent
                            )}
                            %
                          </TableCell>
                          <TableCell
                          ...
                          >
                            {activeCol == 6 ? (
                              <Progress
                                strokeWidth={30}
                                percent={parseInt(
                                  data.total_ivr[key].totalavgtime
                                )}
                              />
                            ) : (
                              data.total_ivr[key].totalavgtime
                      ...
                      <TableRow>
                        ...
                        <TableCell
                          ...
                          colSpan={activeCol == 6 ? BREAKDOWN_COL : 1}
                        >
                          {Math.round(data.totalavgeragetime)}
                        </TableCell>
                        <TableCell />
                      </TableRow>
                    </TableBody>
                          ...
                          {my_data[key].data > 0 ? (
                            my_data[key].data ? (
                              [
                                ...
                                />,
                                <TableCell colSpan={my_data[key].remain1} />
                              ]
                            ) : (
                              [
                            ...
                            <TableCell colSpan={data.callscale.length} />
                          )}
                          <TableCell>{my_data[key].data}</TableCell>
                        </TableRow>
                      ))}
                      <TableRow>
                        <TableCell colSpan={data.callscale.length + 1} />
                        <TableCell>{data.total_calls}</TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
