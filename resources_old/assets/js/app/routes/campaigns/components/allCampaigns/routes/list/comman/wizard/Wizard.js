...
class Clone extends React.Component {
  ...
  state = {
    ...
    agent_pause_id: "",
    cloneError: false,
    inboundSetps: ["Step 1", "Step 2"],
    outboundSteps: ["Step 1", "Step 2", "Step 3"]
  };
  totalSteps = () => {
    return this.getSteps().length;
  };
  getSteps = () => {
    return this.state.camp_type == "outbound"
      ? this.state.outboundSteps
      : this.state.inboundSetps;
  };
  ...
  checkvalidation = () => {
    ...
    this.state.camp_caller_cid == ""
      ? this.setState({ cloneError: true })
      : this.setState({ cloneError: false });
    this.state.autodail == "" && this.state.camp_type == "outbound"
      ? this.setState({ cloneError: true })
      : this.setState({ cloneError: false });
    this.state.shift_id == "" && this.state.camp_type == "outbound"
      ? this.setState({ cloneError: true })
      : this.setState({ cloneError: false });
    this.state.amd_id == "" && this.state.camp_type == "outbound"
      ? this.setState({ cloneError: true })
      : this.setState({ cloneError: false });
